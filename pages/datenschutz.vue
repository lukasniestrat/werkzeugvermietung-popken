    ...
    <section class="section">
      <div class="section__inner section__inner--medium">
        <div class="content">
          ...
          <p>Joachim Popken<br>Mittelweg 109<br>26624 Südbrookmerland</p>
...
export default {
  ...
  head () {
    return {
      title: 'Datenschutz | Werkzeug-, Geräte- & Partyzeltzubehör J. Popken',
      meta: [
        { name: 'robots', content: 'noindex,follow' },
        {
          hid: 'description',
          name: 'description',
          content: 'Datenschutz Werkzeugvermietung Popken'
        }
      ]
    }
  }
